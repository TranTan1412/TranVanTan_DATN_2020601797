...
//import RefundOrder from "./OrderRefund";
...
const AdminProduct = () => {
  ...
  return (
    <div>
      <WrapperHeader>Quản lý các đơn hàng</WrapperHeader>
      <Tabs defaultActiveKey="1" onChange={onTabChange}>
        <Tabs.TabPane tab="Đơn mới" key="1">
          <OrderNew reload={reload} />
        </Tabs.TabPane>
        <Tabs.TabPane tab="Đơn đang xử lý" key="2">
          <OrderProcess reload={reload} />
        </Tabs.TabPane>
        <Tabs.TabPane tab="Đơn thành công" key="3">
          <OrderSuccess reload={reload} />
        </Tabs.TabPane>
        <Tabs.TabPane tab="Đơn đã hủy" key="4">
          <OrderCancel reload={reload} />
        </Tabs.TabPane>
        <Tabs.TabPane tab="Đơn hoàn" key="5">
          <RefundOrder reload={reload} />
        </Tabs.TabPane>
      </Tabs>
