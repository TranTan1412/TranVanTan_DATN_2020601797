  ...
  return (
    <div className="product">
      ...
      <div className="product__info">
        ...
        <div className="product__info__item">
          <div className="product__info__item__title">Chọn màu sắc</div>
        ...
        <div className="product__info__item">
          <div className="product__info__item__title">Chọn kích cỡ</div>
          <div className="product__info__item__list">
            {product &&
        ...
        <div className="product__info__item">
          <div className="product__info__item__title">Chọn số lượng</div>
          ...
          <div style={{ marginTop: "10px", fontSize: "16px" }}>
              <strong>Số lượng sản phẩm còn lại:</strong> {product ? product.quantity : 0}
          </div>
        </div>
        <div className="product__info__item">
          <div className="product__info__item__list">
            <Button onClick={() => addToCart()}>Thêm vào giỏ hàng</Button>
            <Button onClick={() => goToCart()}>Đặt mua ngay</Button>
          </div>
        </div>
      </div>
    </div>
